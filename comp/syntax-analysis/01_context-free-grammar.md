...
<summary>[Is there any algorithm or method that can check whether a grammar is ambiguous?](https://en.wikipedia.org/wiki/Ambiguous_grammar#Recognizing_ambiguous_grammars)[^3]</summary>
